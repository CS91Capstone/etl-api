...
def transform(records: list) -> list:
    ...
    for record in records:
        ...
        data['facility_id'] = record[1]
        data['campsite_name'] = record[2]
        data['campsite_type'] = record[3] 
        data['type_of_use'] = record[4] 
        data['campsite_accessible'] = record[5] 
        data['campsite_reservable'] = record[6] 
        data['campsite_longitude'] = record[7] 
        data['campsite_latitude'] = record[8] 
